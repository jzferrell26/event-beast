...
export const adminResources: Record<string, AdminResource> = {
  ...
  speakers: { title: "Speakers", singular: "Speaker", description: "Use organizer-approved names, photographs and biographies.", titleField: "full_name", subtitleField: "title", order: "full_name", fields: [text("full_name", "Speaker name", 120, true), text("title", "Role / title", 160), paragraph("bio", "Biography", 5000), url("headshot_url", "Public headshot URL"), url("source_url", "Official speaker source"), published, sample] },

...
The production website was deployed from application revision `7ffc599f5b6281ee43c1307e3d405d93835144ab` to `https://event-beast-51bxm7po9-cuantico-ai.vercel.app`, aliased to `https://event-beast.vercel.app`. Nine post-deployment checks passed: live backend/program content, anonymous private-API denial, five mobile public pages with zero automated accessibility violations, email-signup gate, and actual public offline guide. Mobile Home, Agenda, Speakers and Join screenshots were visually reviewed. GitHub Actions run `35856344955` passed for that application revision. See `docs/public-website-release.json`. Signup email remains intentionally unavailable until production SMTP is qualified.
